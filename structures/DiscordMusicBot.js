...
class DiscordMusicBot extends Client {
    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          .setAuthor(`Tocando Agora ♪`, this.config.IconURL)
      ...
      .on("queueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("A fila acabou", this.config.IconURL)
          .setColor("RANDOM")
          .setTimestamp();
  ...
  sendError(Channel, Error) {
    let embed = new MessageEmbed()
      ...
      .setFooter(
        "Se você acha que isso é um bug por favor, reporte para o servidor de suporte! https://discord.gg/3RAR33gzrn"
      );
