...
module.exports = {
    ...
    SlashCommand: {
        options: [
            {
                name: "level",
                description: `Forneça um nível de bassboost. Níveis disponíveis: low, medium, high, ou none`,
                value: "[level]",
                type: 3,
                required: true,
            },
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            return client.sendTime(interaction, `✅ | **Nível de bassboost para definido para:** \`${level}\``);
        },
    },
};
